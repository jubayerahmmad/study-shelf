...
const UpdateBooks = () => {
  const { image, category, name, authorName, rating } = useLoaderData();
  //   console.log(book);
  ...
  return (
    <div className="max-w-6xl mx-auto border-2 border-purple-950 p-6 m-4">
      <div className="text-center space-y-3">
        <h2 className="text-3xl lg:text-5xl font-semibold">Update Books</h2>
      ...
      <div className="lg:flex items-center gap-4">
        ...
        <div className="lg:w-2/3 p-6">
          <form onClick={handleUpdate} class="w-full mx-auto">
            {/* Image */}
